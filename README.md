...
1. Find your gif, split it into frame by frame using [https://ezgif.com]()  and convert it to byte array with image. Im using canvas 128x32, drawmode using vertical and im using adruino code for my animation with [https://javl.github.io/image2cpp/]()
